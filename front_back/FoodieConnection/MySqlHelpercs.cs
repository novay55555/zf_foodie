...
namespace Foodie.DataBase
{
    ...
    public abstract class MySqlHelper
    {
        ...
        //#region 数据库连接字符串
        //static XmlHelper xml = new XmlHelper();
        //private static string GetXmlConfigValue = xml.GetXmlConfigValue("SqlServer_Foodie");
        //public static readonly string DBConnectionString = GetXmlConfigValue;
